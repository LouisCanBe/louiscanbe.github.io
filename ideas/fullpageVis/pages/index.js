...
class App extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            fullpages: [
                { text: "0 贫困起点与早期努力", context: "hello" },
                { text: "1 扶贫计划与标准提升", context: 'hello' },
                { text: '2 脱贫攻坚的关键阶段', context: 'hello' },
                { text: '3 脱贫攻坚的决战决胜', context: 'hello' }
            ]
        };
    }
    ...
    handleChangeColors() {
        ...
        this.setState({ sectionsColor: newColors });
    }
    ...
    handleAddSection() {
        this.setState(state => {
            ...
            fullpages.push({ text: `section ${length + 1}`, id: Math.random() });
            return { fullpages: [...fullpages] };
        });
    }
    ...
    render() {
        ...
        const Menu = () => (
            <div className="menu" style={{ position: "fixed", top: 0, zIndex: 100 }}>
